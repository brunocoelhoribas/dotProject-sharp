                    ...
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
                            <h1 class="h4 fw-bold text-dark mb-0">
                                {{ __('projects/views.edit.title') }}
                                <span class="text-muted fw-normal fs-6 ms-2">| {{ $project->project_name }}</span>
                            </h1>
                        </div>
                        ...
                        <form method="POST" action="{{ route('projects.update', $project) }}">
                            ...
                            <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                                <a href="{{ route('projects.show', $project) }}" class="btn btn-secondary btn-sm px-4">
                                    {{ __('projects/views.form.cancel') }}
                                </a>
                                <button type="submit" class="btn btn-primary btn-sm px-4">
                                    <i class="bi bi-check-lg me-1"></i> {{ __('projects/views.form.update') }}
                                </button>
                            </div>
